...
using ESnail.Utilities.Win32API;
...
///  The ReportOut class handles Output reports and Feature reports that carry data to the device.
...
{    
    internal sealed class Hid  
    {
        ...
        internal ESnail.Utilities.Win32API.HID.HIDP_CAPS Capabilities;
        internal ESnail.Utilities.Win32API.HID.HIDD_ATTRIBUTES DeviceAttributes; 
        ...
        {             
            ...
            ///  </summary>
            internal abstract void Read( SafeFileHandle hidHandle,
        ...
        {             
            ...
            internal override void Read( SafeFileHandle hidHandle,
                                         SafeFileHandle readHandle,
                                         SafeFileHandle writeHandle,
                                         ref Boolean myDeviceDetected,
            ...
            {                 
                ...
                { 
                    ...
                    //  ***                    
                    success = ESnail.Utilities.Win32API.HID.HidD_GetFeature(hidHandle, inFeatureReportBuffer, inFeatureReportBuffer.Length); 
                                        
                    Debug.Print( "HidD_GetFeature success = " + success );                     
                } 
                catch ( Exception ex ) 
                { 
                    LogException( MODULE_NAME, ex ); 
                    throw ; 
                }

            }// Read()

        }// class InFeatureRepor
        ...
        {             
            ...
            {                 
                ...
                {                     
                    ...
                    //  Returns: true on success, false on failure.
                    //  ***
                    success = ESnail.Utilities.Win32API.HID.HidD_GetInputReport(hidHandle, inputReportBuffer, inputReportBuffer.Length + 1); 
        ...
        }// class InputReportViaControlTransfer
        ...
        {          
            ...
            ///  <param name="readHandle"> the handle for reading Input reports from the device. </param>
            ///  <param name="writeHandle"> the handle for writing Output reports to the device. </param>
            internal void CancelTransfer(SafeFileHandle hidHandle,
                                         SafeFileHandle readHandle,
                                         SafeFileHandle writeHandle,
                                         IntPtr eventObject) 
            {                 
                ...
                try
                {
                    result = ESnail.Utilities.Win32API.WinBase.CancelIo(readHandle);
                }
                catch (System.ObjectDisposedException ode)
                {
                    // TODO: what to do?
                    System.Console.WriteLine(ode.ToString());
                    result = 0;
                }
            ...
            {                 
                ...
                //  ***
                eventObject = ESnail.Utilities.Win32API.WinBase.CreateEvent(IntPtr.Zero, false, false, "");                     
                                         ...
                                         ref Boolean    success)
            {
                ...
                Read(hidHandle, readHandle, writeHandle, ref myDeviceDetected, ref inputReportBuffer, ref result);
            ...
            internal void Read( SafeFileHandle hidHandle,
                                SafeFileHandle readHandle,
                                SafeFileHandle writeHandle,
                                ref Boolean    myDeviceDetected,
                                ref Byte[]     inputReportBuffer,
            ...
            {                 
                ...
                {
                    LogException(MODULE_NAME, ome.GetBaseException() );
                    throw;
                }
                ...
                {
                    LogException(MODULE_NAME, ae.GetBaseException() );
                    throw;
                }
                ...
                try
                {
                    ...
                    success = ESnail.Utilities.Win32API.WinBase.ReadFile(readHandle,
                                                        nonManagedBuffer,
                ...
                if (!success)
                {
                    ...
                    result = ESnail.Utilities.Win32API.WinBase.WaitForSingleObject(eventObject, 50);

                    //  Find out if ReadFile completed or timeout.
                    switch (result)
                    {
                        case ESnail.Utilities.Win32API.WinBase.WAIT_OBJECT_0:
                            ...
                            try
                            {
                                ESnail.Utilities.Win32API.WinBase.GetOverlappedResult(readHandle, nonManagedOverlapped, ref numberOfBytesRead, false);
                            }
                            catch (Exception )
                            {
                                success = false;
                        ...
                        case ESnail.Utilities.Win32API.WinBase.WAIT_TIMEOUT:
                ...
                try
                {
                    ESnail.Utilities.Win32API.WinBase.CloseHandle(eventObject);
        ...
        }// class InputReportViaInterruptTransfer
        ...
        {            
            ...
            {                 
                ...
                { 
                    ...
                    //  Returns: true on success, false on failure.
                    //  ***
                    success = ESnail.Utilities.Win32API.HID.HidD_SetFeature(hidHandle, outFeatureReportBuffer, outFeatureReportBuffer.Length); 
        ...
        {             
            ...
            {                 
                ...
                { 
                    ...
                    //  Returns: true on success, false on failure.
                    //  ***                    
                    success = ESnail.Utilities.Win32API.HID.HidD_SetOutputReport(hidHandle, outputReportBuffer, outputReportBuffer.Length + 1); 
        ...
        {             
            ...
            {                 
                ...
                { 
                    ...
                    //  Returns: True on success, False on failure.
                    //  ***
                    success = ESnail.Utilities.Win32API.WinBase.WriteFile(writeHandle,
                                                         outputReportBuffer,
        ...
        {             
            ...
            { 
                ...
                //  Returns: True on success, False on failure.
                //  ***
                success = ESnail.Utilities.Win32API.HID.HidD_FlushQueue(hidHandle); 
        ...
        ///  </returns>
        internal ESnail.Utilities.Win32API.HID.HIDP_CAPS GetDeviceCapabilities(SafeFileHandle hidHandle) 
        {             
			...
			try
			{
				...
				//  True on success, False on failure.
				//  ***
                success = ESnail.Utilities.Win32API.HID.HidD_GetPreparsedData(hidHandle, ref preparsedData);
				...
				//  Returns: True on success, False on failure.
				//  ***
                result = ESnail.Utilities.Win32API.HID.HidP_GetCaps(preparsedData, ref Capabilities);
                ...
                if ((result != 0))
				{
                    ...
                    result = ESnail.Utilities.Win32API.HID.HidP_GetValueCaps(ESnail.Utilities.Win32API.HID.HidP_Input, valueCaps, ref vcSize, preparsedData);
			...
			finally
			{
				if (preparsedData != IntPtr.Zero)
				{
                    ...
                    //  Returns: True on success, False on failure.
                    //  ***
                    success = ESnail.Utilities.Win32API.HID.HidD_FreePreparsedData(preparsedData);
				}
			} 
        ...
        ///  </returns>
        internal String GetHidUsage(ESnail.Utilities.Win32API.HID.HIDP_CAPS MyCapabilities) 
        {             
            Int32 usage = 0; 
        ...
        {             
            ...
            try
            {
                if (!((IsWindows98Gold())))
                {
                    ...
                    //  Returns: True on success, False on failure.
                    //  ***
                    success = ESnail.Utilities.Win32API.HID.HidD_GetNumInputBuffers(hidDeviceObject, ref numberOfInputBuffers);
                }
                else
                {
                    //
        ...
        {              
            ...
            { 
                ...
                {                     
                    ...
                    //  Returns: true on success, false on failure.
                    //  ***
                    ESnail.Utilities.Win32API.HID.HidD_SetNumInputBuffers(hidDeviceObject, numberBuffers);
        ...
        internal static void LogException( String moduleName, Exception e ) 
        {
            String message =   "Exception: " + e.Message  + Environment.NewLine
