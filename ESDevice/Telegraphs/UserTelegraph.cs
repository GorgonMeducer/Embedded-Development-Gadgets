...
{
    public class UserTelegraph : SinglePhaseTelegraph
    {
        private Boolean m_bMightIgnoreCMDCode = false;
        ...
        public Boolean MightIgnoreCommandCode
        {
            get { return m_bMightIgnoreCMDCode; }
        }
        ...
        private Int32 DecodeIgnoreCMDCode(ref Queue<System.Byte> InputQueue, ref Boolean tRequestDrop)
        {
            //! check input queue
            ...
            //! frame address
            Byte Command = m_Command.Command ;
            UInt16 CheckSUM = 0xFFFF;
            UInt16 DataLength = 0;
            Byte[] Datas = null;
        ...
        public override Int32 Decode(ref Queue<System.Byte> InputQueue, ref Boolean tRequestDrop)
        {
            ...
            do
            {
                tResult = DecodeNormal(ref InputQueue, ref tRequestDrop);
                if (0 != tResult) 
                { 
                    break; 
                }
                if (!MightIgnoreCommandCode)
                {
                    break;
                }
                tResult = DecodeIgnoreCMDCode(ref InputQueue, ref tRequestDrop);
        ...
        public override Telegraph GetTestTelegraph()
        {
            ...
            tCommand.Description = "User-telegraph testing telegraph";


            return new UserTelegraph(tCommand);
        }
        ...
        public override Telegraph CreateTelegraph(params object[] Args)
        {
            ...
            return new UserTelegraph(Args[0] as ESCommand);
        }
